...
* **'Cause I'm Strong Enough: Reasoning about Consistency Choices in Distributed Systems**  
  ([preprint](http://lip6.fr/Marc.Shapiro/papers/CISE-POPL-2016.pdf))  
...
* **Decidability of Inferring Inductive Invariants**  
  ([preprint](http://www.cs.tau.ac.il/~odedp/Decidability_of_Inferring_Inductive_Invariants_POPL16.pdf))  
...
* **From MinX to MinC: Semantics-Driven Decompilation of Recursive Datatypes**  
  ([preprint](https://kar.kent.ac.uk/51097/7/main.pdf))  
